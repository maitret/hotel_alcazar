...
<div style="background-color:#E6E7E8; height:5px;"></div><br><br>           </td>        <td width="38">&nbsp;</td>    <td width="394" align="right" valign="top"><p><img src="img/Imagen_Parrafo_Index.png" width="418" height="211"></p>          <p>&nbsp;</p>          <table width="100%" border="0" cellspacing="0" cellpadding="0">            <tr>           <td class="txt_clima" width="50%">El clima en la ciudad</td>              <td width="50%"><script>$(document).ready(function() {$( "#Widget_Clima" ).load( "clima/get_info_clima.php");});</script><div id="Widget_Clima"></div>          </td>
</tr>
</table>          <p>&nbsp;</p></td>      </tr>      <tr>        <td>&nbsp;</td>        
